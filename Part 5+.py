...
draw_pumpkin(t, -200, -300, 100)
draw_eye(t, -240, -190, 30)  # Left eye
draw_eye(t, -160, -190, 30)  # Right eye
draw_mouth(t, -240, -220, 80)  # Mouth
t.up()
t.goto(-150, -300)
t.down()

draw_pumpkin(t, -50, -300, 80)
draw_eye(t, -70, -220, 25)
draw_eye(t, -50, -220, 25)
draw_mouth(t, -80, -260, 60)

draw_pumpkin(t, 175, -300, 100)
